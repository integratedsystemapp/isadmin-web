                      ...
                      builder: (context, constraints) {
                        ...
                        return Padding(
                          ...
                          child: DataTable2(
                            ...
                            columns: const [
                              DataColumn2(
                                label: Center(child: TableColumnText('순번')),
                                fixedWidth: 50,
                              ),
                              DataColumn2(
                              ...
                              DataColumn2(
                                label: Center(child: TableColumnText('수신전화번호')),
                                fixedWidth: 100,
                              ),
                              DataColumn2(
                                label: Center(child: TableColumnText('수신자명')),
                                fixedWidth: 100,
                              ),
                              DataColumn2(
                                label: Center(child: TableColumnText('푸시발송시간')),
                                fixedWidth: 150,
                              ),

                              // ⬇️ 가변 1
                              DataColumn2(
                                label: Center(child: TableColumnText('푸시제목')),
                              ),

                              // ⬇️ 가변 2
                              DataColumn2(
                                label: Center(child: TableColumnText('푸시내용')),
                              ),

                              DataColumn2(
                                label: Center(
                                  child: TableColumnText('유료메시지\n발송시간'),
                                ),
                                fixedWidth: 150,
                              ),
                              DataColumn2(
                              ...
                              DataColumn2(
                                label: Center(child: TableColumnText('DI No')),
                                fixedWidth: 50,
                              ),
                              DataColumn2(
                            ...
                            rows: List<
                              DataRow2
                            >.generate(controller.alertSendHistoryList.length, (
                              index,
                            ) {
