                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: DataTable2(
                            ...
                            columns: const [
                              DataColumn2(
                                label: Center(child: TableColumnText('경보ID')),
                                fixedWidth: 80,
                              ),
                              DataColumn2(
                                label: Center(child: TableColumnText('경보발송시간')),
                                fixedWidth: 160,
                              ),
                              DataColumn2(
                                label: Center(child: TableColumnText('경보확인시간')),
                                fixedWidth: 160,
                              ),
                              DataColumn2(
                                label: Center(
                                  child: TableColumnText('경보확인사용자ID'),
                                ),
                                fixedWidth: 140,
                              ),
                              DataColumn2(
                              ...
                              DataColumn2(
                                label: Center(child: TableColumnText('경보명')),
                                fixedWidth: 180,
                              ),
                              DataColumn2(
                                label: Center(child: TableColumnText('센서명')),
                                fixedWidth: 180,
                              ),
                              DataColumn2(
                                label: Center(child: TableColumnText('map id')),
                                fixedWidth: 300,
                              ),
                              DataColumn2(
                                label: Center(child: TableColumnText('sop id')),
                                fixedWidth: 300,
                              ),
                              DataColumn2(
                                label: Center(
                                  child: TableColumnText('cctv id'),
                                ),
                                fixedWidth: 300,
                              ),
                              ...
                              DataColumn2(
                                label: Center(child: TableColumnText('경보상태')),
                                fixedWidth: 110,
                              ),
                              DataColumn2(
                                label: Center(child: TableColumnText('오경보여부')),
                                fixedWidth: 120,
                              ),

                              // ⬇️ 가변 폭 — 남는 공간 흡수
                              DataColumn2(
                                label: Center(child: TableColumnText('경보발생사유')),
                              ),
                            ...
                            rows: List<
                              DataRow2
                            >.generate(controller.alertHistoryList.length, (
                              index,
                            ) {
                                ...
                                cells:
                                    [
                                          ...
                                          DataCell(
                                            Center(
                                              child: TableCellText(
                                                DateWebUtils.toYYYYMMDDWithTime(
                                                  a.alertOccurredAt,
                                                ),
                                              ),
                                            ),
