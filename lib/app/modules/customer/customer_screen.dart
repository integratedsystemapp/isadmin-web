...
//                   debugPrint('===================================>');
//                   if (result != null) {
//                     final _index = controller.customerList.indexWhere((e) => e.companyCd == result.companyCd);
//
//                     debugPrint('=====>${result.toString()}');
//                     debugPrint('_index:${_index}');
//
//                     if (_index >= 0) {
//                       controller.customerList[_index] = result;
//                       showCustomSnackbar('성공', '고객 정보 수정이  완료 되었습니다.');
//                     } else {
//                       showCustomSnackbar('성공', '고객 정보 수정이 실패 했습니다.');
//                     }
//
//                   }
//
...
//                 // 삭제 로직
//                 if (controller.selected.isNotEmpty) {
//                   final _companyCd = controller.getSelected()!.companyCd;
//                   final result = await confirmDelete(_companyCd);
//                   if (result == true) {
//                     try {
//                       await controller.deleteCustomer(_companyCd);
//                       debugPrint('삭제 성공!');
//                       final index = controller.customerList.indexWhere((e) => e.companyCd == _companyCd);
//                       if (index >= 0) {
...
//       //         // bottomMargin: 10,
//       //         minWidth: 3000,
//       //         sortColumnIndex: controller.sortColumnIndex.value ?? null,
...
//       //             onSort: (columnIndex, ascending) => controller.sortBy<String>((e) => e.companyCd, columnIndex, ascending),
//       //           ),
//       //
//       //           DataColumn2(label: const Center(child: TableColumnText('회사명')), fixedWidth: 150,
//       //             onSort: (columnIndex, ascending) => controller.sortBy<String>((e) => e.companyName, columnIndex, ascending),
//       //           ),
//       //           const DataColumn2(label: Center(child: TableColumnText('사업자\n등록번호')), fixedWidth: 100),
//       //           const DataColumn2(label: Center(child: TableColumnText('주소')), fixedWidth: 100),
//       //           const DataColumn2(label: Center(child: TableColumnText('대표번호')), fixedWidth: 100),
//       //           const DataColumn2(label: Center(child: TableColumnText('대표자')), fixedWidth: 100),
//       //           const DataColumn2(label: Center(child: TableColumnText('업태')), fixedWidth: 100),
//       //           const DataColumn2(label: Center(child: TableColumnText('종목')), fixedWidth: 100),
//       //           const DataColumn2(label: Center(child: TableColumnText('담당자\n성명')), fixedWidth: 100),
//       //           const DataColumn2(label: Center(child: TableColumnText('담당자\n직책')), fixedWidth: 100),
//       //           const DataColumn2(label: Center(child: TableColumnText('담당자\n유선전화')), fixedWidth: 100),
//       //           const DataColumn2(label: Center(child: TableColumnText('담당자\n휴대전화')), fixedWidth: 120),
//       //           const DataColumn2(label: Center(child: TableColumnText('담당자\n이메일')), fixedWidth: 200),
//       //           const DataColumn2(label: Center(child: TableColumnText('계산서\n발행일')), fixedWidth: 100),
//       //           const DataColumn2(label: Center(child: TableColumnText('계산서\n발행금액')), fixedWidth: 100),
//       //           const DataColumn2(label: Center(child: TableColumnText('이폼사인ID')), fixedWidth: 100),
//       //           const DataColumn2(label: Center(child: TableColumnText('서비스\n사용여부')), fixedWidth: 100),
//       //           const DataColumn2(label: Center(child: TableColumnText('계약서 발송')), fixedWidth: 100),
//       //           const DataColumn2(label: Center(child: TableColumnText('다운로드')), fixedWidth: 100),
//       //           const DataColumn2(label: Center(child: TableColumnText('첨부파일\n다운로드')), fixedWidth: 100),
...
//       //                   DataCell(Center(child: TableCellText(customer.companyName))),
//       //                   DataCell(Center(child: TableCellText(customer.businessRegistrationNo ?? ''))),
...
//       //                   DataCell(Center(child: TableCellText(customer.companyPhoneNo ?? ''))),
//       //                   DataCell(Center(child: TableCellText(customer.ceoName ?? ''))),
//       //                   DataCell(Center(child: TableCellText(customer.businessTypeCd ?? ''))),
//       //                   DataCell(Center(child: TableCellText(customer.businessItem ?? ''))),
//       //                   DataCell(Center(child: TableCellText(customer.managerName ?? ''))),
//       //                   DataCell(Center(child: TableCellText(customer.managerPosition ?? ''))),
//       //                   DataCell(Center(child: TableCellText(customer.managerTelNo ?? ''))),
//       //                   DataCell(Center(child: TableCellText(customer.managerMobileNo ?? ''))),
//       //                   DataCell(Center(child: TableCellText(customer.managerEmail ?? ''))),
//       //                   DataCell(Center(child: TableCellText(customer.invoiceIssueDate ?? ''))),
//       //                   DataCell(Center(child: TableCellText(customer.formatContractAmount()))),
//       //                   // DataCell(Center(child: TableCellText(customer.contractAmount?.toString() ?? ''))),
//       //
//       //                   // DataCell(Center(child: TableCellText(customer.eformsignDocId ?? ''))),
//       //                   buildEformSignIdCell(customer.eformsignDocId),
//       //
//       //                   DataCell(Center(child: TableCellText(customer.isServiceEnabled))),
//       //                   DataCell(Center(child: (customer.isValidEformDocId()) ? Text('발송 완료') :
//       //
//       //                   ElevatedButton(onPressed: () async {
//       //
//       //                     debugPrint('send contract document....${customer.managerMobileNo?.replaceAll('-', '').length}');
//       //
//       //                     if (customer.managerMobileNo == null || customer.managerMobileNo?.replaceAll('-', '').length != 11) {
//       //                       showCustomSnackbar('오류', '담당자 휴대전화 등록 후 이용하세요');
//       //                       return;
//       //                     }
//       //                     if (customer.companyName.isEmpty) {
//       //                       showCustomSnackbar('오류', '회사명 등록 후 이용하세요');
//       //                       return;
//       //                     }
//       //                     if (customer.managerName == null || customer.managerName!.isEmpty) {
//       //                       showCustomSnackbar('오류', '담당자 이름 등록 후 이용하세요');
//       //                       return;
//       //                     }
//       //
//       //                     // controller.sendContractDocument(customer);
//       //                     //  return;
//       //
//       //
//       //
//       //                     // final managerEmail = (customer.managerEmail != null && customer.managerEmail!.isEmpty) ? '-' : customer.managerEmail ?? ''
//       //                         '-';
//       //
//       //                     debugPrint('customer.companyCd:${customer.companyCd}');
//       //                     debugPrint('customer.companyName:${customer.companyName}');
//       //                     // debugPrint('managerEmail:${managerEmail}');
//       //
//       //                     final data = ContractInitData(
//       //                       companyCd: customer.companyCd,
//       //                       companyName: customer.companyName,
//       //                       bizNo: customer.businessRegistrationNo ?? '-',
...
//       //                     );
//       //
//       //                     final contractSendModel = await openContractSendDialog(data);
//       //
//       //                     // debugPrint('res:${res.message},${res.isSendToMobile}');
//       //                     if (contractSendModel == null) {
//       //                       debugPrint('취소버튼');
//       //                       return;
//       //                     }
//       //
//       //                     final documentId = await controller.sendContractDocument(contractSendModel);
//       //
//       //                     // 계약서발송 다큐먼트ID 업데이트
//       //                     if (documentId != null || documentId!.isEmpty) {
//       //                       final index = controller.customerList.indexWhere((e)=> e.companyCd == customer.companyCd);
//       //                       customer.eformsignDocId = documentId;
//       //                       if (index >= 0)
//       //                         controller.customerList[index] = customer;
//       //                     }
//       //
//       //                     /*
//       //                     if (res != null) {
//       //                       Get.snackbar(
//       //                         '결과',
//       //                         '발송: ${res.isSendToMobile}, 휴대폰: ${res.managerMobile ?? '-'}, 메시지: ${res.message ?? '-'}',
...
//       //                   다운로드1
//       //                    */
//       //                   DataCell(Center(child: (!customer.isValidEformDocId())?Text('-'):
//       //                   ElevatedButton(onPressed: ()  {
//       //                     debugPrint('download....${customer.eformsignDocId},${customer.eformsignDocId?.length}');
//       //                     // final docId = 'c8146532cc5e44deb542f48a6732aec5';
//       //                     if (customer.eformsignDocId != null) {
//       //                       final docId = customer.eformsignDocId!;
//       //                       controller.downloadDocument(docId);
//       //                     } else {
//       //                       showCustomSnackbar('안내', '계약 문서가 존재하지 않습니다.');
//       //                     }
//       //
//       //                   }, child: Text('다운로드'),))
//       //                   ),
...
//       //                    */
//       //                   DataCell(Center(child:(!customer.isValidEformDocId()) ? Text('-') :
//       //                   ElevatedButton(onPressed: (customer.eformsignDocId == null)?null:(){
//       //                     debugPrint('download attach....');
//       //                     // final docId = 'c8146532cc5e44deb542f48a6732aec5';
//       //                     if (customer.eformsignDocId != null) {
//       //                       final docId = customer.eformsignDocId!;
//       //                       controller.downloadAttachDocument(docId);
//       //
//       //                     } else {
//       //                       showCustomSnackbar('안내', '계약문서 존재하지 않습니다.');
//       //                     }
//       //
//       //
//       //                   }, child: Text('다운로드'),))),
                ...
                if (controller.selected.isNotEmpty) {
                  ...
                  if (result != null) {
                    final idx = controller.customerList
                        .indexWhere((e) => e.companyCd == result.companyCd);
                    if (idx >= 0) {
                ...
                if (controller.selected.isNotEmpty) {
                  ...
                  if (result == true) {
                    try {
                      ...
                      final index = controller.customerList
                          .indexWhere((e) => e.companyCd == companyCd);
                      if (index >= 0) {
                        controller.customerList.removeAt(index);
                      }
                      showCustomSnackbar('성공', '고객 정보 삭제가  완료 되었습니다.');
                  ...
                  columns: [
                    ...
                    DataColumn2(
                      ...
                      onSort: (columnIndex, ascending) => controller
                          .sortBy<String>(
                              (e) => e.companyCd, columnIndex, ascending),
                    ),
                    ...
                    DataColumn2(
                      ...
                      onSort: (columnIndex, ascending) => controller
                          .sortBy<String>(
                              (e) => e.companyName, columnIndex, ascending),
                    ),
                  ...
                  rows: List.generate(controller.customerList.length, (index) {
                    ...
                    return DataRow2.byIndex(
                      ...
                      cells: [
                        ...
                        // 회사 코드/명
                        DataCell(Center(
                            child: TableCellText(customer.companyCd,
                                fontSize: 14))),
                        DataCell(Center(
                            child: TableCellText(customer.companyName,
                                fontSize: 14))),
                        ...
                        DataCell(Center(
                            child: TableCellText(
                                ...
                                fontSize: 14))),
                        DataCell(Center(
                            child: TableCellText(customer.ceoName ?? '',
                                fontSize: 14))),
                        DataCell(Center(
                            child: TableCellText(
                                ...
                                fontSize: 14))),
                        DataCell(Center(
                            child: TableCellText(customer.businessItem ?? '',
                                fontSize: 14))),

                        // 담당자 정보
                        DataCell(Center(
                            child: TableCellText(customer.managerName ?? '',
                                fontSize: 14))),
                        DataCell(Center(
                            child: TableCellText(
                                ...
                                fontSize: 14))),
                        DataCell(Center(
                            child: TableCellText(customer.managerTelNo ?? '',
                                fontSize: 14))),
                        DataCell(Center(
                            child: TableCellText(customer.managerMobileNo ?? '',
                                fontSize: 14))),
                        ...
                        DataCell(
                          Align(
                            alignment: Alignment.centerLeft,
                            child: TableCellText(customer.managerEmail ?? '',
                                fontSize: 14,
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis),
                          ),
                        ...
                        // 서비스 사용여부
                        DataCell(Center(
                            child: TableCellText(customer.isServiceEnabled,
                                fontSize: 14))),
/*
                        // 계약서 발송 버튼
                        DataCell(
