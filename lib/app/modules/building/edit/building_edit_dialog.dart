...
class BuildingEditDialog extends StatelessWidget {
  ...
  BuildingEditDialog({super.key, required this.mode, required this.initialData, required this.onSave});
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                            ...
                            mode == '등록' ?
                              Obx(() {
                                ...
                                return DropdownButtonFormField<String>(
                                  ...
                                  decoration: const InputDecoration(labelText: '회사 선택', border: OutlineInputBorder()),
                        ...
                        child: Column(children: [
                                  ...
                                  onTap: () async {
                                    ...
                                    html.window.onMessage.first.then((event) {
                                      ...
                                      if (data is Map) {
                                        ...
                                        controller.controllers['address']?.text = '${zc} ${addr}';
                                      }
                                    });
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: TextFormField(
                                  controller: controller.controllers['address_detail'],
                                  style: TextStyle(fontSize: 12),
                                  decoration: const InputDecoration(border: OutlineInputBorder()),
                                  validator: (value) {
                                    if(controller.controllers['address_detail'] != null
                                        && controller.controllers['address_detail']!.text.isNotEmpty) {
                                      if (value == null || value.trim().isEmpty) {
                                        return '상세주소를 입력해주세요';
                                      }
                                    } else {
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TextFormField(
                              controller: controller.controllers['contractTermMonths'],
                              inputFormatters: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TextFormField(
                              controller: controller.controllers['usageStartDate'],
                              style: TextStyle(fontSize: 12),
                              decoration: const InputDecoration(border: OutlineInputBorder(), hintText: '20251101',
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TextFormField(
                              ...
                              style: TextStyle(fontSize: 12),
                              decoration: const InputDecoration(border: OutlineInputBorder(), hintText: '20251201'),
                              validator: (value) {
                                if (value == null || value.trim().isEmpty) {
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TextFormField(
                              controller: controller.controllers['managerPosition'],
                              style: TextStyle(fontSize: 12),
                              decoration: const InputDecoration(border: OutlineInputBorder()),
                              validator: (value) {
                                /*
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TextFormField(
                              controller: controller.controllers['managerPhoneNo'],
                              style: TextStyle(fontSize: 12),
                              decoration: const InputDecoration(border: OutlineInputBorder()),
                              validator: (value) {
                                /*
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          // 필수여부 아이콘 표시
                          Text('*', style: TextStyle(color: Colors.red)),
                          SizedBox(width: labelWidth, child: Text('유료 메시지 수신 여부')),
                          Spacer(),
                          Switch(value: controller.isReceivePaidMsg.value,
                              onChanged: (val) => controller.isReceivePaidMsg.value = val),
                        ],
                      ),
                    ),
                    ...
                    //       // 필수여부 아이콘 표시
                    //       Text('*', style: TextStyle(color: Colors.red)),
                    //       SizedBox(width: labelWidth, child: Text('빌딩 이미지')),
                    //       Spacer(),
                    ...
                    //         children: [
                    //         Text('등록이미지 파일명'),
                    //         Text(controller.pickedFile.value?.fileName ?? 'n/a'),
                    //       ],)),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Spacer(),
                          Switch(value: controller.isServiceEnabled.value,
                              onChanged: (val) => controller.isServiceEnabled.value = val),
                        ],
                      ),
                    ),
                  ],
